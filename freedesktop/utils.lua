...
function parse_desktop_file(arg)
    ...
    if program.NoDisplay == "true" or program.OnlyShowIn ~= nil and not (program.OnlyShowIn:find( "awesome" ) or program.OnlyShowIn:find( os.getenv('XDG_SESSION_DESKTOP') or "" ) )then
        program.show = false
    end
